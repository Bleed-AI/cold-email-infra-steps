...
export default function SprintScreen({ businessName, deckHandleRef, onDone }: ScreenProps) {
  ...
  const steps: NarrationStep[] = useMemo(
    () => [
      ...
      { n: "03", title: "One campaign per segment", detail: <p>Every segment gets its own angle, offer and subject line — never one message duct-taped across the whole list.</p> },
