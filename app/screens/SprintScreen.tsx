...
export default function SprintScreen({ businessName, deckHandleRef, onDone }: ScreenProps) {
  ...
  const steps: NarrationStep[] = useMemo(
    () => [
      ...
      { n: "03", title: "One campaign per segment", detail: <p>Every segment gets its own angle, offer and channel mix — email, LinkedIn, call, SMS — never one message duct-taped across the whole list.</p> },
